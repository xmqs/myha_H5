    ...
    <div class="wall">
      <div class="scroll">
          <div class="cell" @click="toDetail">
            <div class="title">南京市建伟物业管理有限公司南京市建伟物业管理有限公司</div>
            <div class="content">
              <span>二级</span>
              <span class="number">苏物业宁字2028号</span>
            </div>
          </div>
          <div class="cell" @click="toDetail">
            <div class="title">南京市建伟物业管理有限公司</div>
            <div class="content">
              <span>二级</span>
              <span class="number">苏物业宁字2028号</span>
            </div>
          ...
          <div class="cell">
            <div class="title">南京市建伟物业管理有限公司南</div>
            <div class="content">
              <span>二级</span>
              <span class="number">苏物业宁字2028号</span>
            </div>
          ...
          <div class="cell">
            <div class="title">南京市建伟物业管理有限公司南京市建伟物</div>
            <div class="content">
              <span>二级</span>
              <span class="number"></span>
            </div>
