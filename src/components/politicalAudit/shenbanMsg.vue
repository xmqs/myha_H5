<template>
  <div id="Msg">
    ...
    <div id="bumenMsg">
      ...
      <div>
        <span>咨询电话</span>
        <a class="phone" :href="'tel:'+shenbanList.result">{{shenbanList.result}}</a>
      </div>
    </div>
    <!--切换栏-->
    <div id="cutMsg">
        ...
        <div v-show="page==1">
          ...
          <div>
            ...
            <div class="content" v-show="!isshow3">
              <div><img v-show="shenbanList.taskoutimg!=undefined && shenbanList.taskoutimg!=''" style="width:100%;"
                        :src="shenbanList.taskoutimg"/></div>
            </div>
          </div>
          <div>
          ...
          <div>
            <div class="flex" @click="on5">
              <span>办理结果形式</span>
              <span class="mui-icon mui-icon-arrowright" :class="{actived:!isshow5}"></span>
              <span class="mui-icon mui-icon-arrowdown" :class="{actived:isshow5}"></span>
            </div>
            <div class="content" v-show="!isshow5">
              <div>{{shenbanList.resultJson.resultname==undefined?"":shenbanList.resultJson.resultname}}</div>
              <div>{{shenbanList.resultJson.resulttype}}</div>
            </div>
          </div>
        </div>
        <!--申请材料-->
        <div v-show="page==2">
          <div class="cailiaoMsg" v-for="val in materiallist">
            ...
            <div class="c3">
              ...
              <div>
                <a :href="val.exampleattachguid"><img src="../../../static/img/politicalAudit/Group 5@2x.png"/>&nbsp;&nbsp;预览</a>
