	...
	<div id="body">
	   ...
	   <div id="lunbo">
			  ...
			  <div class="mui-slider-group">
			    <div class="mui-slider-item"><a href="#"><img src="../../../static/img/politicalAudit/demo.jpg" /></a></div>
			    <div class="mui-slider-item"><a href="#"><img src="../../../static/img/politicalAudit/demo.jpg" /></a></div>
			    <div class="mui-slider-item"><a href="#"><img src="../../../static/img/politicalAudit/demo.jpg" /></a></div>
			    <div class="mui-slider-item"><a href="#"><img src="../../../static/img/politicalAudit/demo.jpg" /></a></div>
			  </div>
	   ...
	   <div id="shenban">
	   	  ...
	   	  <div id="shenbanMain">
	   	  	<div v-for="val in zhanshiList.data" @click="jumpshenban(val.taskguid)">
	   	  	   ...
	   	  	   <div style="width:100%">{{val.taskname.length>8?val.taskname.slice(0,8)+"..." : val.taskname}}</div>
	   	  	</div>
	   	  </div>
	   </div>
	   <!--事项分类-->
