    ...
    <ul class="list_ui">
      ...
      <li class="list_li5">
        ...
        <div class="add_inp7">
          ...
          <img src="./../../../static/img/hotline/unclick.png" alt="" class="clickIcon" v-show="data.caseIsvisit!==1"
               @click="data.caseIsvisit=1">
          <span class="clickTip" @click="data.caseIsvisit=1">是</span>
          <img src="./../../../static/img/hotline/click.png" alt="" class="clickIcon" v-show="data.caseIsvisit!==1">
          <img src="./../../../static/img/hotline/unclick.png" alt="" class="clickIcon" v-show="data.caseIsvisit==1"
               @click="data.caseIsvisit=0">
          <span class="clickTip" @click="data.caseIsvisit=0">否</span>
        </div>
      </li>
      <li class="list_li">
        <div class="word"> 回访电话</div>
        <div class="add_inp2" style="color: #838383">{{data.cusPhone.slice(0,3)}}****{{data.cusPhone.slice(7,11)}} <span
          class="showName">{{showName}}</span></div>
      </li>
    </ul>
  ...
  export default {
    ...
    methods: {
      ...
      add() {
        ...
        if (this.areaName == "请选择事发区域" || this.data.appealArea == "") {
