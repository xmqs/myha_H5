<template>
  <div id="cityList">
    <div class="inp">
      <img style="width: 15px;position: absolute; top: 4.5vw;left: 8vw;" src="../../../static/img/hotline/Fill1.png"/><input class="inp_s searchdetails" placeholder="请输入搜索关键字" type="text" v-model="area" @keyup="selectArea"/>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList(){
        var that = this;
        axios.get('/myha-server/delivery/flight/queryCities.do').then(function(data) {
