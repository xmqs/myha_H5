    ...
    <ul class="content">
      ...
      <li class="chage_destination">
        ...
        <div class="icon_destination" @click="changeFT">
          <img src="./../../../static/img/hotline/rollcoin.png" alt=""  v-bind:class="{'change':changing}">
        </div>
      ...
      <li>
        <router-link :to="{name:'selectPlane',query:{pname:planeCom}}">
...
<style scoped>
  ...
  .content li.chage_destination{
    ...
    position: relative;
    height: 132px;
    background: url("./../../../static/img/hotline/rollPlane.png") center no-repeat;
