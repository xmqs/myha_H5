  ...
  <div>
    <div class="SearchAod">
      <div @click="rightIcon" v-if="!showAoD">
        <img src="./../../../static/img/hotline/in.png" alt="" v-if="direction=='A'">
        <img src="./../../../static/img/hotline/out.png" alt=""  v-if="direction=='D'">
      </div>
    ...
    <div id="wall">
      <div id="scoll">
        <Loadmore infinite-scroll-distance="1" :top-method="loadTop" :bottom-method="loadBottom"
