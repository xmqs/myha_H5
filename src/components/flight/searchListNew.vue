<template>
    <div>
      <div id="wall">
        <div id="scoll">
          <Loadmore infinite-scroll-distance="1" :top-method="loadTop" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" :auto-fill="false" ref="loadmore">
    ...
    export default {
      ...
      activated(){
          if(this.$route.params.planeCom||this.$route.params.planeFrom||this.$route.params.planeTo||this.$route.params.planeNumber){
            ...
            if(this.$route.params.Int){
              this.Url = '/myha-server/airFlight/getAirInternatFlight.do'
            }else{
              this.Url = '/myha-server/airFlight/getAirFlight.do'
            }
      ...
      methods:{
        loadTop() {
          ...
          axios.post('/myha-server/airFlight/getAirFlight.do',{
            "isFirst":"0",
...
<style scoped>
  ...
  .timeList{
    width: 160px;
    text-align: center;
    background: url("./../../../static/img/hotline/line_to.png") center no-repeat;
